...
p8 = { "P8",{ 4, 5, 6, 14, 16, 6 },
{ 14, 33, 51, 73, 87 }, 0, 0, 0, 0, -1, 0, 0, 1, 0 };
...
int main()
{
	...
	int TQ1 = 5;		//time quantum for first queue
	int TQ2 = 10;		//time quantum for second queue
